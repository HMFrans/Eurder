...
public class CustomerMapper {
    public Customer DtoToMember(NewMemberDto newMemberDto) {
        return new Customer(newMemberDto.getPassword(), newMemberDto.getFirstName(), newMemberDto.getLastName(), newMemberDto.getEmailAddress(), newMemberDto.getPhoneNumber(),
